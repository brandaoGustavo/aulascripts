   ...
   $.ajax({ 
         ...
         success : function(data){ 
             ...
             for(var i=0; i < data.length; i++){ 
               $("#tabela > tbody").append("<tr id='p"+(data[i].id )+"'><td>"+data[i].nome +"</td><td>"+data[i].descricao+"</td><td>"+data[i].preco+"</td> <td><a onclick='deletar("+(data[i].id)+")'><span class='glyphicon glyphicon-trash'></span></a></td><td><a onclick='editar("+(data[i].id)+")'><span class='glyphicon glyphicon-pencil'></span></a></td>");
             } 
